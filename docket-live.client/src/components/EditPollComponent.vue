<template>
  <div class="component" v-if="poll.questions">
    <div
      ...
      v-for="(q, index) in poll.questions"
      :key="q.id"
    >
      <div class="col-md-4">
        <p class="m-0">
          ...
          <input
            type="text"
            class="w-75 questions"
            :placeholder="q.body"
            v-model="poll.questions[index].body"
          />
        </p>
      </div>
      <div
        class="col-md-2 col-6 mt-2 mt-md-0"
      ...
      >
        <input
          ...
          v-model="poll.questions[index].choices[i].content"
        />
      </div>
    </div>
    <!-- ------------------------------------- New Question Inputs -------------------------- -->
    <div class="row my-4">
      <div class="col-md-4">
        <div class="row">
          <div class="col-2">
            <i
              class="mdi mdi-plus-circle mdi-24px text-primary icon"
              title="Add Question"
              @click="addQuestion"
            ></i>
          </div>
